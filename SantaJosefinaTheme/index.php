...
<section class="hero">
  <div>
    ...
    <h1 style="font-size:42px; margin-bottom:20px;">Conectamos personas y propiedades</h1>
...
<section id="copropiedad">
  ...
  <p style="max-width:800px; color:#444;">
    ...
    <br>Estamos inscritos en el Registro Nacional de Administradores de Copropiedades del Minvu.
  </p>
...
// Cargar propiedades disponibles desde AppSheet
async function cargarPropiedadesLanding(){
  ...
  document.getElementById("listaPropiedades").innerHTML = disponibles.map(p=>`
    <div>
      ...
      <div style="padding:15px;">
        ...
        <a href="#contacto" class="btn-outline">Más información</a>
       <br> 
        <br> </div>
